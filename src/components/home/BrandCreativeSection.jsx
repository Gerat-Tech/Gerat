                  ...
                  <div className="pt-6 border-t border-white/10 flex flex-col gap-4">
                    <div className="flex flex-wrap gap-1.5">
                      {card.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-2.5 py-1 bg-white/5 border border-white/10 font-parkinsans text-[9px] tracking-[0.1em] uppercase text-white/60 group-hover:text-white group-hover:border-white/20 transition-colors rounded-[1px]"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="pt-2 flex items-center justify-between">
                      <Link
                        href={card.link}
                        className="inline-flex items-center gap-2 font-parkinsans text-[10px] tracking-[0.2em] uppercase text-accent hover:text-white transition-colors"
                      >
          ...
          <div className="flex items-center gap-4">
            <Magnetic maxDisplacement={6}>
              <Link
                ...
                className="px-6 py-3 bg-white text-black font-parkinsans text-[10px] tracking-[0.2em] uppercase font-bold hover:bg-accent hover:text-white transition-all rounded-[2px]"
              >
            ...
            <Magnetic maxDisplacement={6}>
              <Link
                ...
                className="px-6 py-3 border border-white/20 bg-transparent text-white/80 font-parkinsans text-[10px] tracking-[0.2em] uppercase font-bold hover:bg-white hover:text-black transition-all rounded-[2px]"
              >
                FOUNDER BRANDING
              </Link>
            </Magnetic>
