  ...
  return (
    <div className="relative w-full max-w-[1440px] mx-auto pt-32 sm:pt-40 pb-12 px-4 sm:px-6 md:px-8 lg:px-10 text-white">
      <div className="flex flex-col gap-6 max-w-4xl">
        <SectionLabel label="LEADERSHIP & ENGINEERING" />

        <div className="space-y-1 sm:space-y-2">
          <SplitText
            text="ENGINEERED WITH RIGOR."
            as="h1"
            className="font-parkinsans text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-medium sm:font-semibold tracking-tight uppercase leading-[0.92]"
          />
          <SplitText
        ...
        <FadeUp delay={0.3} y={16}>
          <p className="font-artific text-base sm:text-lg text-white/75 max-w-2xl leading-relaxed">
      ...
      <div className="mt-12 pt-4 border-t border-white/10 flex items-center justify-between font-artific text-[10px] tracking-[0.2em] text-white/50 uppercase font-medium">
