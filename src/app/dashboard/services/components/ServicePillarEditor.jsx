...
export default function ServicePillarEditor({ initialData = null, isNew = false }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/10">
        <div>
          <div className="flex items-center gap-2">
            <Link
              ...
              className="font-parkinsans text-[10px] text-white/50 hover:text-white uppercase tracking-wider"
            >
              ← PRACTICE PILLARS
            </Link>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={saving}
            className="py-2 px-6 bg-accent hover:bg-accent/90 text-black font-parkinsans text-[10px] tracking-[0.15em] font-bold uppercase rounded-[2px] transition-colors disabled:opacity-50"
          >
      ...
      {success && (
        <div className="p-4 bg-emerald-950/40 border border-emerald-500/50 rounded-[2px] font-parkinsans text-xs text-emerald-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <form onSubmit={handleSubmit} className="lg:col-span-7 flex flex-col gap-6">
          ...
          <div className="bg-[#121212] border border-white/10 p-6 rounded-[3px] flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label className="block font-parkinsans text-[10px] tracking-[0.15em] text-white/50 uppercase mb-1">
                  INDEX NUMBER (e.g. 01) *
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-black/60 border border-white/15 px-3 py-2 text-white font-parkinsans text-xs rounded-[2px] focus:border-accent outline-none"
                >
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-black/60 border border-white/15 px-3 py-2 text-white font-artific text-sm uppercase rounded-[2px] focus:border-accent outline-none"
              />
            </div>
          ...
          <div className="bg-[#121212] border border-white/10 p-6 rounded-[3px] flex flex-col gap-4">
            ...
            <div>
              ...
              />
              <span className="font-parkinsans text-[9px] text-white/40 mt-1 block">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          <div className="font-parkinsans text-[10px] tracking-[0.2em] text-white/40 uppercase font-bold flex items-center justify-between">
            ...
            <div>
              ...
              <div className="pt-6 border-t border-white/10">
                ...
                {deliverablesArray.length > 0 ? (
                  ...
                  <div className="font-parkinsans text-[10px] text-white/30 italic">
                ...
                {formData.deepLink && (
                  <div className="mt-4 pt-3 border-t border-white/5">
                    <span className="inline-flex items-center gap-1.5 font-parkinsans text-[9px] tracking-[0.2em] uppercase text-accent">
