    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/10">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/dashboard"
            className="py-2 px-3 bg-white/[0.04] hover:bg-white/10 border border-white/15 text-white/80 font-parkinsans text-[10px] tracking-[0.15em] uppercase rounded-[2px] transition-colors"
          >
            ← COCKPIT
          </Link>
        </div>
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="bg-[#121212] border border-white/10 p-4 rounded-[3px]">
          <div className="font-parkinsans text-[9px] tracking-[0.2em] text-cyan-400 uppercase">
            ACTIVE PIPELINE
          </div>
          <div className="font-artific text-2xl sm:text-3xl font-bold text-cyan-400 mt-1">
