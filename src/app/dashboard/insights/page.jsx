    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/10">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="py-2 px-4 bg-accent hover:bg-accent/90 text-black font-parkinsans text-[10px] tracking-[0.15em] font-bold uppercase rounded-[2px] transition-colors flex items-center gap-1.5"
          >
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-[#121212] border border-white/10 p-4 rounded-[3px]">
          ...
          <div className="font-artific text-2xl sm:text-3xl font-bold text-white mt-1">
            {total.toString().padStart(2, "0")}
          </div>
        </div>

        <div className="bg-[#121212] border border-white/10 p-4 rounded-[3px]">
          <div className="font-parkinsans text-[9px] tracking-[0.2em] text-emerald-400 uppercase">
            PUBLISHED LIVE
          </div>
          <div className="font-artific text-2xl sm:text-3xl font-bold text-emerald-400 mt-1">
            {published.toString().padStart(2, "0")}
          </div>
        </div>

        <div className="bg-[#121212] border border-white/10 p-4 rounded-[3px]">
          <div className="font-parkinsans text-[9px] tracking-[0.2em] text-amber-400 uppercase">
            IN EDITORIAL REVIEW
          </div>
          <div className="font-artific text-2xl sm:text-3xl font-bold text-amber-400 mt-1">
        ...
        <div className="bg-[#121212] border border-white/10 p-4 rounded-[3px]">
          ...
          <div className="font-artific text-2xl sm:text-3xl font-bold text-white/70 mt-1">
