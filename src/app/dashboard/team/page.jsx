    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="bg-[#121212] border border-white/10 p-4 rounded-[3px]">
          ...
          <div className="font-artific text-2xl sm:text-3xl font-bold text-accent mt-1">
            {leadershipCount.toString().padStart(2, "0")}
          </div>
        </div>

        <div className="bg-[#121212] border border-white/10 p-4 rounded-[3px]">
          <div className="font-parkinsans text-[9px] tracking-[0.2em] text-blue-400 uppercase">
            ENGINEERING CADRE
          </div>
          <div className="font-artific text-2xl sm:text-3xl font-bold text-blue-400 mt-1">
